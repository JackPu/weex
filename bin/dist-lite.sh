...
cp ./dist/lite.js ${dist_dir}/weex.lite.js
cp ./dist/lite.common.js ${dist_dir}/weex.lite.common.js
# cp ${dist_dir}/weex.js ${dist_dir}/weex.common.js
echo -e "\nmodule.exports = global.weex;" >> ${dist_dir}/weex.lite.common.js

uglifyjs ${dist_dir}/weex.lite.js -o ${dist_dir}/weex.lite.min.js
