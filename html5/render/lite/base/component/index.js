...
import { watchIfNeeded, isComponentAppear } from './appearWatcher'
...
export default function Component (data, nodeType) {
  ...
  // this.createChildren()
  // this.updateAttr(this.data.attr || {})
...
Component.prototype = {
  ...
  getWeexInstance () {
    return this.getDocument()._weexInstance
  },

  getParent () {
    return this.getDocument().componentMap[this.parentRef]
  },
  ...
  isScrollable () {
    ...
    return scrollableTypes.indexOf(t) !== -1
  },
